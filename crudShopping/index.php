...
<body>
    ...
    <!--Barra de navegação -->
        ...
        <form class="form-inline">
            <button style="position: relative; right: 30px; color:white;" type="button" class="btn btn-warning" data-toggle="modal" data-target="#CadastrarShopping" type="button">Cadastrar Shopping</button>
            <div class="dropdown">
        ...
        <div class="modal-dialog" role="document">
            ...
            <div class="modal-header">
                <h5 style="color: red;" class="modal-title" id="Login">Cadastrar Shopping</h5>
            ...
            <div class="modal-body">
                <form action="insert.php" method="post">
                    ...
                    <div class="form-group">
                        <input type="text" class="form-control" name="nome_shopping" placeholder="Digite o nome do shopping" required>
                    </div>
...
<div  style ="margin-top: 20px;" class="container">
    <table class="table table-striped table-bordered table-hover" id="tabela">
        ...
        <tbody>
            ...
            <?php foreach($dados as $shopping)  : ?>
            <tr style="background-color: white;">
                <td><?php echo $shopping['nome_shopping']; ?></td>
                <td><?php echo $shopping['endereco']; ?></td>
                <td><?php echo $shopping['tel_fixo']; ?></td>

                <td>
                    <a href="delete.php?codigo=<?php echo $shopping['idshopping']; ?>" class="btn btn-danger">Excluir</a>            				
                </td>
            </tr>
            <!-- fim do laco foreach -->
            <?php endforeach;?>
