...
<body>
    ...
    <!--Barra de navegação -->
        ...
        <form class="form-inline">
            <button style="position: relative; right: 30px; color:white;" type="button" class="btn btn-primary" data-toggle="modal" data-target="#CadastrarUsuario" type="button">Cadastrar Usuário</button>
            <div class="dropdown">
        ...
        <div class="modal fade" id="CadastrarUsuario" tabindex="-1" role="dialog" aria-labelledby="Login" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
            <div class="modal-header">
                <h5 style="color: red;" class="modal-title" id="Login">Cadastrar Usuario</h5>
            ...
            <div class="modal-body">
                <form action="insert.php" method="post">
                    ...
                    <div class="form-group">
                        <input type="text" class="form-control" name="nome_usuario" placeholder="Digite um nome" required>
                    </div>

                    <div class="form-group">
                        <input type="text" class="form-control" name="email" placeholder="Digite um email" required>
                    </div>
    ...
    <table class="table table-striped table-bordered table-hover" id="tabela">
        ...
        <tbody>
            ...
            <tr style="background-color: white;">
                ...
                <td>                   
                   <a href="delete.php?codigo=<?php echo $usuario['idusuario']; ?>" class="btn btn-danger">Excluir</a>            				
                </td>
            </tr>
            <!-- fim do laco foreach -->
            <?php endforeach;?>
